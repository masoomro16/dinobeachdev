...
function ServiceCard(props) {
  return (
    <div className="bg-[#FADCD2] w-10/12 md:w-96  h-80 flex flex-col justify-center items-center rounded-xl px-8 md:px-14 md:py-8 py-16 mx-8 mt-8 mb-10 relative">
