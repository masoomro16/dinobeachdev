...
function Hero() {
  return (
    <div className='h-[calc(100vh_-_150px)] flex flex-wrap md:flex-nowrap justify-center items-center mx-5 md:mx-auto md:max-w-7xl max-w-md'>
        ...
        <img src={stamp} className= 'w-30 h-30'/>
        <div>
          <StaticImage
                  alt="beach"
