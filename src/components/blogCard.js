...
function BlogCard(props) {
  ...
  console.log("blogCardprops: ", props.item )

  return (
    <Link to={`/blog/${props.item?.id}`}>
      <div className={`gradient-background h-72 w-72 md:h-96 md:w-96 rounded-xl my-6 flex justify-center self-center md:${props.custom} shrink flex-grow-1 basis-1/3`} >
      {/* <img src={props.item.image?.localFile.publicURL}/>  */}
