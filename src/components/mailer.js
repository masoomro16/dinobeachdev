...
const Mailer = () => {
	const inputStyles = 'bg-[#FFDE9D] content-text rounded-md md:py-2 py-1 pl-2 md:h-16'
	const textAreaStyles = 'bg-[#FFDE9D] content-text rounded-md md:py-2 py-1 pl-2 md:h-64'
...
return(
	<div className='md:w-full mx-auto md:ml-10 md:mt-12  w-[80%] my-10'>
		<form onSubmit={sendEmail} ref={form} className='grid grid-cols-1 md:grid-cols-2 gap-4'>
			...
			<select name='package' id='package' className={`${inputStyles} col-span-1 md:col-span-2`}>
			...
			<textarea className={`${textAreaStyles} col-span-1 md:col-span-2`} name='message' value={values.message} placeholder='Your Message'onChange={handleChange} required/>
			...
			<input type='submit' value='send' className='ml-auto md:mt-8 md:col-start-2 p-2 md:p-4 w-24 md:w-36 md:text-3xl title-text gradient-text font-extrabold shadow-lg rounded' />	
